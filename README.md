...
![A-0](https://github.com/Artyom-Ivanov627/kurs/blob/main/img/model/model%208.png)

* A0 (диаграмма верхнего уровня)

![A0](https://github.com/Artyom-Ivanov627/kurs/blob/main/img/model/model%209.png)
* A2 (декомпозиция процесса/процессов внутренней среды)

![A2](https://github.com/Artyom-Ivanov627/kurs/blob/main/img/model/model%2010.png)

* A3 (декомпозиция процесса/процессов внутренней среды)

![A3](https://github.com/Artyom-Ivanov627/kurs/blob/main/img/model/model%2011.png)

* A4 (декомпозиция процесса/процессов внутренней среды)

![A4](https://github.com/Artyom-Ivanov627/kurs/blob/main/img/model/model%2014.png)
...
**Конфигурация программных средств:** Одноуровневые.

**Допустимые виды хранилищ и их размещение:** Запоминающее устройство ПК.

* A32 Автоматизация процесса А32

![A32](https://github.com/Artyom-Ivanov627/kurs/blob/main/img/model/model%2012.png)

* A33 Автоматизация процесса А33

![A33](https://github.com/Artyom-Ivanov627/kurs/blob/main/img/model/model%2013.png)
