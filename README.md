...
|---|---|---|
|Запуск программы |Инструмент| Обеспечить работоспособность системы |
| Пользователь | Внешний  | Произвести голосовой запрос |
| Голосовой помощник | Инструмент| Переход на сайт или в поисковую систему |
|Программа|Инструмент|Обеспечить работоспособность системы|
...
* Переход на сайт или в поисковую систему
...
|Пользователь|Произносит стоп слово|Завершение работы с голосовым помощником|
